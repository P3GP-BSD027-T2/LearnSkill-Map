...
export default function Home() {
  return (
<main className="flex flex-col items-center justify-center bg-gradient-to-b from-blue-50 to-white">
  <section className="flex flex-col items-center justify-center min-h-screen px-4">
    ...
    {/*Title */}
    <h1 className="text-4xl font-extrabold text-gray-900 text-center max-w-2xl leading-snug mb-7">
    ...
    <div className="mt-12 grid grid-cols-1 sm:grid-cols-3 gap-8 text-center">
     ...
     <section className="w-full max-w-6xl px-6 py-5">
      ...
      <div className="mt-10 text-center">
        <button className="px-6 py-2 rounded-lg border border-blue-500 text-blue-600 font-medium hover:bg-blue-50 transition">
          View All Roadmaps →
        </button>
      </div>
    </section>
